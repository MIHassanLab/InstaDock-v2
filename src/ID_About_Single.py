...
from PyQt5.QtWidgets import (
    QTabWidget, QGridLayout, QHBoxLayout, QLabel, QMainWindow, QToolButton,
...
class AboutSingleUI(QMainWindow):
    def __init__(self):
...
<p align="justify" style="margin:1em 0; line-height:1.4;">
  <strong>InstaDock‑v2 (IDv2)</strong> is a versatile molecular docking platform tailored for accurate, high‑throughput protein–ligand interaction studies. Whether you're analyzing a single compound or screening a focused library, IDv2 combines scientific rigor with intuitive workflows to support your drug discovery research. The <strong>Single Target Docking</strong> module is optimized for detailed docking on individual protein targets, offering in‑depth insights into binding affinity, orientation, and molecular interactions.
</p>

<ul style="margin:0 2em 1em 2em; line-height:1.4;">
  <li>Precision docking algorithms for consistent, reproducible results</li>
  <li>Integrated 2D interaction analysis—hydrogen bonds, hydrophobic contacts, salt bridges</li>
  <li>Interactive Mol* 3D viewer for real‑time, detailed exploration of docking poses</li>
  <li>Optional ADMET prediction add‑on for early pharmacokinetic and toxicity profiling</li>
</ul>

<p align="justify" style="margin:0 0 1em 0; line-height:1.4;">
  Upon completion of each docking run, IDv2 generates a well‑structured output folder to facilitate downstream analysis, including:
</p>

<ul style="margin:0 2em 1em 2em; line-height:1.4;">
  <li>Ranked docking scores with pose evaluation</li>
  <li>All docked conformers and associated structural files</li>
  <li>Detailed 2D interaction diagrams mapping critical molecular contacts</li>
  <li>Binding affinity distribution plots across your ligand set</li>
</ul>
...
'''
        ...
        <ol>
            <li>Browse for working directory (containing receptor and ligand files).</li>
